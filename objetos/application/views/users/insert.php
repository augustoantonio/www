...
<form method="post" enctype="multipart/form-data">
	<ul>
		...
		<li>
			...
			<option value="3" <?=(isset($usuario['cities_idcity'])&&$usuario['cities_idcity']=='acoru�a')?'selected':'';?>>A Coru�a</option>
			</select>
		</li>
		...
		<li>
			...
			<option value="spanish" <?=(isset($usuario['languages'])&&in_array('spanish', $usuario['languages']))?'selected':'';?>>Espa�ol</option>
			</select>
		</li>
		<li>
